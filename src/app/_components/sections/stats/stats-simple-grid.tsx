          ...
          <div className="mx-auto max-w-2xl lg:max-w-none">
            <div className="text-center">
              <h2 className="text-3xl font-bold tracking-tight text-ai-title-regular sm:text-4xl">
                Elite Car Rentals for Every Journey
              </h2>
              <p className="mt-4 text-lg leading-8 text-ai-subtext-regular">
                Experience professionalism and excellence with our premium car rental services tailored to your needs. Drive in comfort and style, wherever the road takes you.
              </p>
            </div>
